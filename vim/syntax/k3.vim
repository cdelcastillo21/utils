" Vim Syntax file
" Language: k3, e333j
" Maintainer: David Sanchez (david.sanchez@1010data.com)
" Last Change: 2018 January
" Originally written by Victor Janas, modified by David Sanchez
...
" k system stuff
syn keyword kSystemFunction _log _exp _abs _sqr _sqrt _floor _sin _cos _tan _asin _acos _atan _sinh _cosh _tanh _lsq _draw _ci _ic _sv _vs _ss _sm _jd _dj _lt _gtime _ltime _lin _in _di _dvl _dv _bin _binl _inv _dot _mul _tl _ssr _hash _bd _db _getenv _host _exit _div _at _setenv _size _and _or _xor _rot _shift _not _del _rename _Free _addr _obj _phr _kv _vk _len _val _sleep _signal _kill _peach _csm _cz _zc _zd _dz _encrypt _decrypt _md5 _sha2 _hd _ceil _gamma _lgamma _erf _erfc _euclid _rint _trunc _choose _round _neuter_anoint _safe _netstat _install
